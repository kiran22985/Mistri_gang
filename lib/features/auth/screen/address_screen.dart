...
import 'package:mistri/features/auth/services/address_services.dart';
            ...
            children: [
              ...
              Form(
                ...
                child: Column(
                  children: [
                    CustomeTextField(
                      controller1: flatBuildingController,
                      hintText: 'Flat, House no, Building',
                      labelText: 'Flat, House no, Building',
                    ),
                    const SizedBox(height: 10),
                    CustomeTextField(
                      controller1: areaController,
                      hintText: 'Area, Street',
                      labelText: 'Area, Street',
                    ),
                    const SizedBox(height: 10),
                    CustomeTextField(
                      controller1: pincodeController,
                      hintText: 'Pincode',
                      labelText: 'Pincode',
                    ),
                    const SizedBox(height: 10),
